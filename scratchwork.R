setwd("~/Miscellaneous/Coursera/Exploratory-Data-Analysis")
...
# Save as RDS file for faster loading in future
saveRDS(data, file="data_household_power_consumption.Rds", compress=FALSE)
#------------------------------------------------------------------------------
...
# Save as RDS file for faster loading in future
saveRDS(subdata, 
        file="data_household_power_consumption_20070201-20070202.Rds", 
        compress=FALSE)
#------------------------------------------------------------------------------
